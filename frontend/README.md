# InvenTree Shipment Data- Frontend Code

This directory contains the frontend code for the InvenTree Shipment Data plugin.
...
This will compile the frontend into the `../inventree_shipment_data/static` directory (ready for distribution).
